...
namespace TEST
{
    public partial class MenProducts : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            try
            {
                sql = "select * from Products where category_name = 2 ";
                td.Rows.Clear();
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            sql = "select * from Products where category_name= 2 and pro_type = " + target;//The Select query
                                                                      //   MessageBox.Show(sql);
        ...
        {
            string sql = "select * from Products where category_name = 2 and  pro_name like '%" + textBox1.Text + "%'";
            td.Rows.Clear();
